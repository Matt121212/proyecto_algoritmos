...
class App:
    ...
    def __init__(self):
        ...
        # frame_logo
        frame_logo = tk.Frame(self.ventana, bd=0, width=300, relief=tk.SOLID, padx=10, pady=10, bg="#10336E")
        frame_logo.pack(side="left", expand=tk.NO, fill=tk.BOTH)
        label = tk.Label(frame_logo, image=logo, bg="#0E2243")
        ...
        etiqueta_usuario = tk.Label(frame_form_fill, text="Mateo", font=('Times', 14), fg="#666a88", bg='#fcfcfc', anchor="w")
